...
from iroha_tui.app.config.options import OPTIONS
from iroha_tui.app.config.exceptions import InvalidOptionValue
    ...
    *   Configuration file: `{"parameter_name": "value"}`
    ...
    def parse_args(self):
        ...
        for key, value in os.environ.items():
            if key.startswith("IROHA_TUI_"):
                name = key[len("IROHA_TUI_"):].lower()
                config[name] = value
