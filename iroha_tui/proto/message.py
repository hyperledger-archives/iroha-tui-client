...
from iroha_tui.proto.parsers import ProtoMessageExplorer


class ProtoMessageProxy:
    """
    Protobuf message proxy.

    This class provides an interface for a more convenient access to probuf
    message fields, for both reading and writing using nested field descriptors.
    ...
    def __init__(self, proto_message):
        ...
        self._message_descriptor = ProtoMessageExplorer(
    ...
    def _verify_path(self, field_path):
        if field_path not in self._fields:
            err_str = (
                "Specified field path does not exit within "
